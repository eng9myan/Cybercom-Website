...
const LAUNCH_URLS: Record<string, string> = {
  "cymed": process.env.NEXT_PUBLIC_CYMED_URL ?? process.env.NEXT_PUBLIC_HEALTH_URL ?? "https://health.cy-com.com",
  "cymed-hospital": process.env.NEXT_PUBLIC_CYMED_HOSPITAL_URL ?? process.env.NEXT_PUBLIC_HOSPITAL_URL ?? "https://hospital.cy-com.com",
  "cymed-clinic": process.env.NEXT_PUBLIC_CYMED_CLINIC_URL ?? process.env.NEXT_PUBLIC_CLINIC_URL ?? "https://clinic.cy-com.com",
  "cymed-laboratory": process.env.NEXT_PUBLIC_CYMED_LAB_URL ?? process.env.NEXT_PUBLIC_LAB_URL ?? "https://lab.cy-com.com",
  "cymed-imaging": process.env.NEXT_PUBLIC_CYMED_IMAGING_URL ?? process.env.NEXT_PUBLIC_IMAGING_URL ?? "https://imaging.cy-com.com",
  "cymed-pharmacy": process.env.NEXT_PUBLIC_CYMED_PHARMACY_URL ?? process.env.NEXT_PUBLIC_PHARMACY_URL ?? "https://pharmacy.cy-com.com",
  "cymed-patient-portal": process.env.NEXT_PUBLIC_CYMED_PATIENT_PORTAL_URL ?? process.env.NEXT_PUBLIC_HEALTH_URL ?? "https://health.cy-com.com",
  "cymed-provider-portal": process.env.NEXT_PUBLIC_CYMED_PROVIDER_PORTAL_URL ?? process.env.NEXT_PUBLIC_PROVIDER_URL ?? "https://provider.cy-com.com",
  "cymed-revenue-cycle": process.env.NEXT_PUBLIC_CYMED_RCM_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/rcm`,
  "cymed-population-health": process.env.NEXT_PUBLIC_CYMED_POPULATION_HEALTH_URL ?? `${process.env.NEXT_PUBLIC_HEALTH_URL ?? "https://health.cy-com.com"}/population`,
  "cycom": process.env.NEXT_PUBLIC_CYCOM_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp`,
  "cygov": process.env.NEXT_PUBLIC_CYGOV_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/gov`,
  "cyidentity": process.env.NEXT_PUBLIC_CYIDENTITY_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/identity`,
  "cyintegrationhub": process.env.NEXT_PUBLIC_CYINTEGRATIONHUB_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/integration`,
  "cyai": process.env.NEXT_PUBLIC_CYAI_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/ai`,
  "cydata": process.env.NEXT_PUBLIC_CYDATA_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/data`,
  "cyconnect": process.env.NEXT_PUBLIC_CYCONNECT_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/connect`,
  "cycitizen": process.env.NEXT_PUBLIC_CYCITIZEN_URL ?? process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com",
  "cycom-finance": process.env.NEXT_PUBLIC_CYCOM_FINANCE_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/finance`,
  "cycom-accounting": process.env.NEXT_PUBLIC_CYCOM_ACCOUNTING_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/accounting`,
  "cycom-procurement": process.env.NEXT_PUBLIC_CYCOM_PROCUREMENT_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/procurement`,
  "cycom-inventory": process.env.NEXT_PUBLIC_CYCOM_INVENTORY_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/inventory`,
  "cycom-hr": process.env.NEXT_PUBLIC_CYCOM_HR_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/hr`,
  "cycom-payroll": process.env.NEXT_PUBLIC_CYCOM_PAYROLL_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/payroll`,
  "cycom-crm": process.env.NEXT_PUBLIC_CYCOM_CRM_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/crm`,
  "cycom-assets": process.env.NEXT_PUBLIC_CYCOM_ASSETS_URL ?? `${process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.cy-com.com"}/erp/assets`,
  ...
  "cyshop-bakery": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
  "cyshop-coffee": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
  "cyshop-fastfood": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
  "cyshop-grocery": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
  "cyshop-supermarket": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
  "cyshop-convenience": process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://cyshop.cy-com.com",
};
