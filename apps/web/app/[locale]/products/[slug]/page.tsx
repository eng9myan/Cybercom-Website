...
const LAUNCH_URLS: Record<string, string | undefined> = {
  "cymed":                    process.env.NEXT_PUBLIC_CYMED_URL ?? "https://health.cy-com.com",
  "cymed-hospital":           process.env.NEXT_PUBLIC_CYMED_HOSPITAL_URL ?? "https://hospital.cy-com.com",
  "cymed-clinic":             process.env.NEXT_PUBLIC_CYMED_CLINIC_URL ?? "https://clinic.cy-com.com",
  "cymed-laboratory":         process.env.NEXT_PUBLIC_CYMED_LAB_URL ?? "https://lab.cy-com.com",
  "cymed-imaging":            process.env.NEXT_PUBLIC_CYMED_IMAGING_URL ?? "https://imaging.cy-com.com",
  "cymed-pharmacy":           process.env.NEXT_PUBLIC_CYMED_PHARMACY_URL ?? "https://pharmacy.cy-com.com",
  "cymed-patient-portal":     process.env.NEXT_PUBLIC_CYMED_PATIENT_PORTAL_URL ?? "https://health.cy-com.com",
  "cymed-provider-portal":    process.env.NEXT_PUBLIC_CYMED_PROVIDER_PORTAL_URL ?? "https://provider.cy-com.com",
  "cymed-revenue-cycle":      process.env.NEXT_PUBLIC_CYMED_RCM_URL ?? "https://portal.cy-com.com/rcm",
  "cymed-population-health":  process.env.NEXT_PUBLIC_CYMED_POPULATION_HEALTH_URL ?? "https://health.cy-com.com/population",
  "cycom":                    process.env.NEXT_PUBLIC_CYCOM_URL ?? "https://portal.cy-com.com/erp",
  "cygov":                    process.env.NEXT_PUBLIC_CYGOV_URL ?? "https://portal.cy-com.com/gov",
  "cyidentity":               process.env.NEXT_PUBLIC_CYIDENTITY_URL ?? "https://portal.cy-com.com/identity",
  ...
  "cycom-finance":            process.env.NEXT_PUBLIC_CYCOM_FINANCE_URL ?? "https://portal.cy-com.com/erp/finance",
  "cycom-accounting":         process.env.NEXT_PUBLIC_CYCOM_ACCOUNTING_URL ?? "https://portal.cy-com.com/erp/accounting",
  "cycom-procurement":        process.env.NEXT_PUBLIC_CYCOM_PROCUREMENT_URL ?? "https://portal.cy-com.com/erp/procurement",
  "cycom-inventory":          process.env.NEXT_PUBLIC_CYCOM_INVENTORY_URL ?? "https://portal.cy-com.com/erp/inventory",
  "cycom-hr":                 process.env.NEXT_PUBLIC_CYCOM_HR_URL ?? "https://portal.cy-com.com/erp/hr",
  "cycom-payroll":            process.env.NEXT_PUBLIC_CYCOM_PAYROLL_URL ?? "https://portal.cy-com.com/erp/payroll",
  "cycom-crm":                process.env.NEXT_PUBLIC_CYCOM_CRM_URL ?? "https://portal.cy-com.com/erp/crm",
  "cycom-assets":             process.env.NEXT_PUBLIC_CYCOM_ASSETS_URL ?? "https://portal.cy-com.com/erp/assets",
  "cycom-manufacturing":      process.env.NEXT_PUBLIC_CYCOM_MANUFACTURING_URL ?? "https://portal.cy-com.com/erp/manufacturing",
  "cycom-retail":             process.env.NEXT_PUBLIC_CYCOM_RETAIL_URL ?? "https://portal.cy-com.com/erp/retail",
  "cycom-bi":                 process.env.NEXT_PUBLIC_CYCOM_BI_URL ?? "https://portal.cy-com.com/erp/bi",
  "cyshop":                   process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-retail":            process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-restaurant":        process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-bakery":            process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-coffee":            process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-fastfood":          process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-grocery":           process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-supermarket":       process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
  "cyshop-convenience":       process.env.NEXT_PUBLIC_CYSHOP_URL ?? "https://portal.cy-com.com/shop",
};
